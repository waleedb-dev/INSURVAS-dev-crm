...
export default function SupportModal({ onClose }: { onClose: () => void }) {
  return (
    ...
    >
      ...
      >
        <button onClick={onClose} style={{ position: "absolute", top: 20, right: 20, background: "none", border: "none", cursor: "pointer", color: "#8a94a6", fontSize: 20, lineHeight: 1, padding: 4, borderRadius: 8, transition: "color 0.15s" }}
        ...
        <p style={{ fontSize: 14, color: "#8a94a6", lineHeight: 1.6, marginBottom: 28 }}>
          Describe your question and our specialists will answer you within 24 hours.
        </p>

        <div style={{ marginBottom: 20 }}>
          <label style={{ fontSize: 13, fontWeight: 700, color: "#8a94a6", display: "block", marginBottom: 8 }}>Request Subject</label>
          <div style={{ position: "relative" }}>
            <select style={{ width: "100%", padding: "13px 40px 13px 16px", border: "1.5px solid #e2e8f0", borderRadius: 12, fontSize: 14, color: "#374151", backgroundColor: "#fff", appearance: "none", cursor: "pointer", fontFamily: "inherit" }}>
              <option>Technical difficulties</option>
              <option>Billing enquiry</option>
              <option>Feature request</option>
              <option>Other</option>
            </select>
            <span style={{ position: "absolute", right: 14, top: "50%", transform: "translateY(-50%)", pointerEvents: "none", color: "#8a94a6" }}>▾</span>
          </div>
        </div>
        ...
        <div style={{ display: "flex", justifyContent: "flex-end", gap: 10 }}>
          <button onClick={onClose} style={{ backgroundColor: "transparent", color: "#8a94a6", border: "1.5px solid #e2e8f0", borderRadius: 12, padding: "13px 24px", fontSize: 14, fontWeight: 700, cursor: "pointer", fontFamily: "inherit", transition: "border-color 0.15s" }}
...
function SupportIllustration() {
  return (
    <svg width="160" height="140" viewBox="0 0 160 140" fill="none">
      ...
      <rect x="48" y="71" width="59" height="30" rx="3" fill="#dbeafe" />
      ...
      <path d="M40 106 L120 106 L115 100 L45 100 Z" fill="#d1d5db" />
      ...
      <ellipse cx="40" cy="85" rx="14" ry="5" fill="#3b82f6" />
      ...
      <rect x="122" y="85" width="16" height="15" rx="3" fill="#f59e0b" />
