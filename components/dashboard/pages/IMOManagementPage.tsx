              ...
              { header: "Created", key: "createdAt", render: (imo) => <span style={{ fontSize: 13, color: T.textMid }}>{imo.createdAt}</span> },
              {
                ...
                render: (imo) => (
                  <div style={{ display: "flex", justifyContent: "center", gap: 8 }}>
                    ...
                    <button onClick={() => deleteItem('imo', imo.id, imo.name)} title="Delete" style={{ background: "none", border: "none", color: "#ef4444", cursor: "pointer", padding: 6 }}>
              ...
              { header: "Created", key: "createdAt", render: (a) => <span style={{ fontSize: 13, color: T.textMid }}>{a.createdAt}</span> },
              {
                ...
                render: (a) => (
                  <div style={{ display: "flex", justifyContent: "center", gap: 8 }}>
                    ...
                    <button onClick={() => deleteItem('agency', a.id, a.name)} title="Delete" style={{ background: "none", border: "none", color: "#ef4444", cursor: "pointer", padding: 6 }}>
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>
                    </button>
                  </div>
                )
              ...
              { 
                ...
                render: (a) => (
                  <span style={{ 
                    ...
                    <div style={{ width: 6, height: 6, borderRadius: "50%", backgroundColor: a.status === 'Active' ? '#22c55e' : '#ef4444' }}/>
                    {a.status}
                  </span>
                )
              },
              ...
              { header: "States", key: "stateCount", align: "center", render: (a) => <span style={{ fontWeight: 700 }}>{a.stateCount}</span> },
              {
                ...
                render: (a) => (
                  <div style={{ display: "flex", justifyContent: "center", gap: 8 }}>
                    ...
                    <button onClick={() => deleteItem('agent', a.id, a.fullName)} title="Delete" style={{ background: "none", border: "none", color: "#ef4444", cursor: "pointer", padding: 6 }}>
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>
                    </button>
                  </div>
                )
                      ...
                      <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                        {agents.filter(a => a.id === agency.id).map(agent => (
                          <div key={agent.id} style={{ display: "flex", alignItems: "center", gap: 8, padding: "8px 12px", backgroundColor: "#f8fafc", borderRadius: 8 }}>
                            <div style={{ width: 8, height: 8, borderRadius: "50%", backgroundColor: agent.status === 'Active' ? '#22c55e' : '#ef4444' }}/>
