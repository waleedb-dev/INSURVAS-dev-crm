...
export function DataGrid({
  ...
  const showFilterPanel = hasFilters && (filtersExpanded || hasActiveFilters);
  const activeFilterCount = useMemo(() => {
    if (!activeFilters) return 0;
    return React.Children.toArray(activeFilters).filter(Boolean).length;
  }, [activeFilters]);
  ...
  return (
    <div style={{ 
      ...
      <>
        <div style={{ 
          padding: "20px 20px", 
          borderBottom: showFilterPanel || hasActiveFilters ? `1px solid ${T.border}` : "none", 
          display: "flex", 
          gap: 16, 
          alignItems: "center", 
        ...
        {showFilterPanel && (
          <div style={{
            padding: "16px 20px",
            borderBottom: hasActiveFilters ? `1px solid ${T.border}` : "none",
            display: "flex",
            gap: 12,
            alignItems: "center",
            flexWrap: "wrap",
